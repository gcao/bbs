...
0
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/forumdisplay.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/header.htm', 1309576726, '1', './templates/default')
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/forumdisplay.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/recommend.htm', 1309576726, '1', './templates/default')
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/forumdisplay.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/footer.htm', 1309576726, '1', './templates/default')
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/forumdisplay.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/jsmenu.htm', 1309576726, '1', './templates/default')
;?>
...
<span class="postbtn" id="newspecialtmp" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"><a href="post.php?action=newthread&amp;fid=<?=$fid?>"<? if(!$forum['allowspecialonly']) { ?> onclick="showWindow('newthread', this.href);return false;"<? } ?>>发帖</a></span>
                ...
                <div class="threadtype">
                        ...
                        <p>
                                <? if($typeid || $sortid) { ?><a href="forumdisplay.php?fid=<?=$fid?>">全部</a><? } else { ?><strong>全部</strong><? } ?>
                                <? if(is_array($forum['threadtypes']['flat'])) { foreach($forum['threadtypes']['flat'] as $id => $name) { if($typeid != $id) { ?><a href="forumdisplay.php?fid=<?=$fid?>&amp;filter=type&amp;typeid=<?=$id?><?=$sortadd?>"><?=$name?></a><? } else { ?><strong><?=$name?></strong><? } ?> <? } } ?>                                <? if($forum['threadtypes']['selectbox']) { ?>
                                        ...
                                        <ul>
                                        <? if(is_array($forum['threadtypes']['selectbox'])) { foreach($forum['threadtypes']['selectbox'] as $id => $name) { ?>                                                <li>
                                                <? if($typeid != $id) { ?>
                        ...
                        <p>
                                <? if(!$forum['threadtypes']['listable']) { if($sortid) { ?><a href="forumdisplay.php?fid=<?=$fid?>">全部</a><? } else { ?><strong>全部</strong><? } } ?>
                                <? if(is_array($forum['threadsorts']['flat'])) { foreach($forum['threadsorts']['flat'] as $id => $name) { if($sortid != $id) { ?><a href="forumdisplay.php?fid=<?=$fid?>&amp;filter=sort&amp;sortid=<?=$id?><?=$typeadd?>"><?=$name?></a><? } else { ?><strong><?=$name?></strong><? } ?> <? } } ?>                                <? if($forum['threadsorts']['selectbox']) { ?>
                                        ...
                                        <ul>
                                        <? if(is_array($forum['threadsorts']['selectbox'])) { foreach($forum['threadsorts']['selectbox'] as $id => $name) { ?>                                                <li>
                                                <? if($sortid != $id) { ?>
