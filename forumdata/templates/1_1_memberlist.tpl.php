<? if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('memberlist');
0
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/memberlist.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/header.htm', 1310957602, '1', './templates/default')
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/memberlist.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/stats_navbar.htm', 1310957602, '1', './templates/default')
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/memberlist.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/footer.htm', 1310957602, '1', './templates/default')
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/memberlist.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/jsmenu.htm', 1310957602, '1', './templates/default')
;?>
...
<div class="datalist">
<div class="c_header">
<h3 class="noarrow"><? if($type != 'birthdays') { ?>会员列表<? } else { ?>今日生日会员列表<? } ?></h3>
<div class="c_header_action">
<? if($type != 'birthdays') { ?>
<div id="footfilter" class="c_header_ext">
...
<table id="list_member" summary="<? if($type != 'birthdays') { ?>会员列表<? } else { ?>今日生日会员列表<? } ?>" cellspacing="0" cellpadding="0" style="margin-bottom: 10px;">
<thead class="colplural">
<tr>
<td><a href="member.php?action=list&amp;order=username" class="dropmenu">用户名</a></td>
<td>UID</td>
<td><a href="member.php?action=list&amp;order=gender" class="dropmenu">性别</a></td>
<td><a href="member.php?action=list&amp;order=regdate" class="dropmenu">注册日期</a></td>
<td>上次访问</td>
<td>帖子</td>
<? if($type != 'birthdays') { ?>
<td><a href="member.php?action=list&amp;order=credits" class="dropmenu">积分</a></td>
<? } else { ?>
<td><a href="member.php?action=list&amp;type=birthdays" class="dropmenu">生日快乐</a></td>
<? } ?>
</tr>
</thead>
<tbody><? if(is_array($memberlist)) { foreach($memberlist as $member) { ?><tr class="<? echo swapclass('colplural'); ?>">
