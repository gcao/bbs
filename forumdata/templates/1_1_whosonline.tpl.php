<? if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('whosonline');
0
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/whosonline.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/header.htm', 1309658268, '1', './templates/default')
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/whosonline.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/footer.htm', 1309658268, '1', './templates/default')
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/whosonline.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/jsmenu.htm', 1309658268, '1', './templates/default')
;?>
...
<tbody><? if(is_array($onlinelist)) { foreach($onlinelist as $online) { ?><tr class="<? echo swapclass('colplural'); ?>">
