...
0
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/showmessage.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/header.htm', 1309576862, '1', './templates/default')
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/showmessage.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/footer.htm', 1309576862, '1', './templates/default')
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/showmessage.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/jsmenu.htm', 1309576862, '1', './templates/default')
;?>
...
<? } else { include template('header_ajax', '0', ''); } $allowreturn = $url_forward || !stristr($show_message, '返回') ? 0 : 1;$alerttype = $url_forward ? (preg_match('/\_succeed$/', $message) ? 'alert_right' : 'alert_info') : ($allowreturn ? 'alert_error' : 'alert_info'); if(!$inajax) { ?>
