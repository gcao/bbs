<? if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('tag');
0
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/tag.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/header.htm', 1309938859, '1', './templates/default')
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/tag.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/footer.htm', 1309938859, '1', './templates/default')
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/tag.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/jsmenu.htm', 1309938859, '1', './templates/default')
;?>
...
<div class="taglist s_clear">
<? if($randtaglist) { if(is_array($randtaglist)) { foreach($randtaglist as $tag) { ?><a href="tag.php?name=<?=$tag['tagnameenc']?>" class="tagl<?=$tag['level']?>" title="<?=$tag['total']?>" target="_blank"><?=$tag['tagname']?></a> <? } } } else { ?>
<em>标签信息不存在</em>
<? } ?>
</div>
</div>
