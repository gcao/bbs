...
0
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/nopermission.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/header.htm', 1309576925, '1', './templates/default')
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/nopermission.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/footer.htm', 1309576925, '1', './templates/default')
|| checktplrefresh('/data/apps/bbs/releases/7.2_20100331/././templates/default/nopermission.htm', '/data/apps/bbs/releases/7.2_20100331/././templates/default/jsmenu.htm', 1309576925, '1', './templates/default')
;?>
...
<p>您无权进行当前操作，原因如下：</p>
<? if($show_message) { ?><p><?=$show_message?></p></div><? } if($discuz_uid) { ?><p class="alert_btnleft"><a href="faq.php?action=grouppermission" target="_blank">查看您当前用户组的权限</a></p></div>
<? } else { ?>
<div class="alert_act">
...
<? } output(); ?></body>
</html><? } else { include template('header', '0', ''); ?><script type="text/javascript" reload="1">
function ajaxerror() {
hideMenu();
<? if(!$discuz_uid) { ?>
